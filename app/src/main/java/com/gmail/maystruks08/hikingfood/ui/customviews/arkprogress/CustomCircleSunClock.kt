package com.gmail.maystruks08.hikingfood.ui.customviews.arkprogress
...
class CustomCircleSunClock(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private var strokeWidth = resources.getDimension(R.dimen.size_xs)
    ...
    init {
        ...
        try {
            ...
            startIcon = drawableToBitmap(resources.getDrawable(R.drawable.ic_check))
            finishIcon = drawableToBitmap(resources.getDrawable(R.drawable.ic_search))
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        paint.color = resources.getColor(R.color.colorLightItem)
