...
import kotlinx.android.synthetic.main.item_loop_ingredient.view.*
import kotlin.properties.Delegates

class VariableProductAdapter(private val clickListener: (ProductView) -> Unit) :
    RecyclerView.Adapter<VariableProductAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_loop_ingredient, parent, false)
